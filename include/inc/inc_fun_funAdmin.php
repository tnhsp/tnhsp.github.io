...
function SpGetNewInfo()
{
    ...
    if (stristr($web_server, 'apache')) {
        $web_server = 'apache';
    } else if (stristr($web_server, 'linux')) {
        $web_server = 'linux';
    ...
    $offUrl = "h"."tt"."p:"."//"."se"."rv"."ice."."de"."de"."5"."8".".c"."om"."/index.php?m=api&c=Dedecms&a=get_upgradeinfo&info=info57&version={$cfg_version}&formurl={$nurl}&phpver={$phpv}&os={$sp_os}&mysqlver={$mysql_ver}&charset={$cfg_soft_lang}{$add_query}&ip={$ip}&web_server={$web_server}";
